                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">{{ $category->nombre }}</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <h1 class="mt-3 text-lg font-bold text-gray-900 dark:text-white sm:text-2xl">{{ $category->nombre }}
                    </h1>
