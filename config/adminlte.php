    ...
    'can'=>'admin.sliders.index',],
        ...
        [
         ...
         [
            ...
            'can'=>'admin.orders.pendiente',
            'submenu' => [
                [
                    'text' => 'Ordenes pendientes',
                    'route'  => 'admin.orders.pendiente',
                    'can'=>'admin.orders.pendiente',
                ],
                // [
                //     'text' => 'Ordenes aprobadas',
                //     'route'  => 'admin.products.create',
                // ],
                [
                    'text' => 'Ordenes enviadas',
                    'route'  => 'admin.orders.enviado',
                    'can'=>'admin.orders.enviado',
                ],
                [
                    'text' => 'Ordenes canceladas',
                    'route'  => 'admin.orders.cancelado',
                    'can'=>'admin.orders.cancelado',
                ],]
        ...
        [
                ...
                'can'=>'admin.payment_methods.index',
